...
class DiaryWidget extends StatefulWidget {
  ...
  @override
  State<DiaryWidget> createState() => _DiaryState();
}

class _DiaryState extends State<DiaryWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<AllProductsCubit>().loadProductsByCategory("diary");
    });
  }
        ...
        children: [
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: 'Search diary and eggs products...',
              hintStyle: TextStyle(
