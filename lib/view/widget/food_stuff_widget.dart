...
class FoodStuffWidget extends StatefulWidget {
  const FoodStuffWidget({Key? key}) : super(key: key);

  @override
  State<FoodStuffWidget> createState() => _FoodStuffState();
}

class _FoodStuffState extends State<FoodStuffWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<AllProductsCubit>().loadProductsByCategory("food stuff");
    });
  }
